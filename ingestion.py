...
document = loader.load() # it reads the PDF, extracts the text, and returns a list of LangChain documents, ready for further processing.
...
texts = text_splitter.split_documents(document) # it splits the documents into smaller chunks for better processing.
